  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `linear-gradient(135deg, var(--bg-nav-dark) 0%, var(--bg-nav) 100%)`,
        }}
      >
        ...
        <p className="text-lg max-w-md mx-auto" style={{ color: "rgba(255,255,255,0.7)" }}>
          Organise events, track who&apos;s coming, and coordinate which games to bring.
        </p>
      </div>
      ...
      <div className="flex-1 flex items-start justify-center px-4 pt-12">
        ...
        >
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 rounded-lg px-4 py-3 text-sm font-semibold transition-all hover:opacity-90 active:scale-[0.98] shadow-sm"
              style={{
